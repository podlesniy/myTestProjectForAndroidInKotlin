...
class MainActivity2 : AppCompatActivity() {
    ...
    private fun getApi(dao: CocktailDao2) {
    ...
    private fun setInfo(drink: CocktailModelInfo.DrinksInfo, dao: CocktailDao2) {
        Picasso.with(this)
...
//        Toast.makeText(this@MainActivity2, dao.selectCocktail(cocktail!!).idDrink, Toast.LENGTH_SHORT).show()
    }
